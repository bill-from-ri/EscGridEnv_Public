...
from minigrid.core.NewObjects import EscObj, ButtonDoor, Crate
...
class Grid:
    ...
    # I'm sorry to whoever has to read this part. It was simply the easiest
    ...
    @classmethod
    def make_agent_red(cls):
        cls.agent_is_red = True
    @classmethod
    def make_agent_not_red(cls):
        cls.agent_is_red = False
    ...
    def render_tile(
        ...
        # THIS is the critical to rendering. Without this component, ---------\
        # the game slows to a crawl.
        if agent_dir is None and not isinstance(obj, (ButtonDoor, Crate)) and key in cls.tile_cache :
            return cls.tile_cache[key]
        # Tamper with it with care. Rely on the cache as much as possible. ---/
        ...
        if agent_dir is not None:
            ...
            if cls.agent_is_red:
                ...
                fill_coords(img, tri_fn, (112, 39, 195))
    ...
    def render(
        ...
        for j in range(0, self.height):
            for i in range(0, self.width):
                ...
                # Put each tile in the right spot.
                ymin = j * tile_size
                ymax = (j + 1) * tile_size
                xmin = i * tile_size
                xmax = (i + 1) * tile_size
    ...
    def decode(array: np.ndarray) -> tuple[Grid, np.ndarray]:
        ...
        for i in range(width):
            for j in range(height):
                ...
                v = EscObj.decode(type_idx, color_idx, state)
                grid.set(i, j, v)
